...
| 4 | [`Docs/DATA_SOURCE_POLICY.md`](Docs/DATA_SOURCE_POLICY.md) | **実測値が食い違うときどれを採るか。** 分布保持・P10-P90 判定 |
| 5 | [`Docs/AGENT_TOPOLOGY.md`](Docs/AGENT_TOPOLOGY.md) | 「作るAI」と「疑うAI」の分離。**評価のオラクルは層によって違う** |
| 6 | [`Docs/SOURCE_A_VERIFICATION.md`](Docs/SOURCE_A_VERIFICATION.md) | 公式諸元表と `vehicle.json` の照合記録。**PDFはテキスト抽出できない** |
| 7 | [`Docs/DATA_COLLECTION_ZN6.md`](Docs/DATA_COLLECTION_ZN6.md) | 収集項目リスト（14カテゴリ） |
| 8 | [`Docs/SPEC_PHASE2_BACKLOG.md`](Docs/SPEC_PHASE2_BACKLOG.md) | 退避したフェーズ |
